...
class SlotListTile extends StatelessWidget {
  ...
  Future<void> _showSlotDetailPage(BuildContext context) async {
    final hasUpdated = await Navigator.pushNamed(context, Routes.slotDetail, arguments: slot) as bool?;
    if(hasUpdated ?? false) {
      onChange();
    }
  }
    ...
    return BlocProvider<RegistryCloseCubit>(
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          onTap: () => _showSlotDetailPage(context),
          child: Padding(
