const kParkingSlotTableName = 'parking_slots';
const kParkingSlotIdColumn = 'id';
const kParkingSlotNameColumn = 'name';
...
const kParkingRegistryLicensePlateColumn = 'licensePlate';
const kParkingRegistryObservationsColumn = 'observations';
